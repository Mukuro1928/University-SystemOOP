...
/**
 * ClubWorkspace.java — Club & Event CRUD Panel
 * ==============================================
 * Team member: [assign to Backend/UI member]
 * Fields: clubName, presidentName + optional event fields
 * DataManager calls: addClub(), deleteClub()
 */
