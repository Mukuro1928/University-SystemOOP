...
public class Main {
    ...
    public static void main(String[] args) {
        // 1. LOAD DATA BEFORE DOING ANYTHING ELSE!
        ...
        // Run your registration flows
        courseRegister();
        studentRegister();
        clubRegister();

        // 2. SAVE ALL DATA TO THE TXT FILES RIGHT BEFORE CLOSING!
        FileHandler.saveAllData(); 
        System.out.println("\nAll data successfully saved to text files!");
